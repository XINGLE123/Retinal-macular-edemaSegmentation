...
def build_resnet(
    ...
    x = Conv2D(init_filters, (7, 7), strides=(2, 2), kernel_regularizer=regular, name='conv0', **conv_params)(x)
    ...
    for stage, rep in enumerate(repetitions):
        for block in range(rep):
            ...
            if block == 0 and stage == 0:
                x = conv_block(filters, stage, block, strides=(1, 1), l1_regular=l1_regular, l2_regular=l2_regular)(x)
                
            elif block == 0:
                x = conv_block(filters, stage, block, strides=(2, 2), l1_regular=l1_regular, l2_regular=l2_regular)(x)
                
            else:
                x = identity_block(filters, stage, block, l1_regular=l1_regular, l2_regular=l2_regular)(x)
